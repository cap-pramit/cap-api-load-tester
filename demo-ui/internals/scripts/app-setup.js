    ...
    const answers = await inquirer.prompt([
      {
        ...
        name: 'appId',
        message:
          'Provide appId for your app. (appId can be obtained once you have created app on Vulcan UI platform, this is used for making api calls, you can update this later also)',
        default: '',
      },
      {
        type: 'confirm',
      ...
      },
      {
        type: 'input',
        name: 'appType',
        message: `Is this a ${NATIVE_APP_TYPE} or ${GLOBAL_APP_TYPE} or ${EXTERNAL_APP_TYPE} app? (This selection cannot be changed once app is created)`,
