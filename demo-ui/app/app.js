...
const store = configureStore(initialState, initialReducers, history);
const MOUNT_NODE = document.getElementById(`${appName}-container`);

const render = () => {
  // always set as standalone false since this is a part of CRM UI suite
  localStorageApi.saveItem(`${appName}__isStandalone`, false);
  ReactDOM.render(
