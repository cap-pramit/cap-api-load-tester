...
const capReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.GET_ORG_USERS_DATA_REQUEST:
      return state.set('fetchingOrgUsersData', REQUEST);
    case actionTypes.GET_ORG_USERS_DATA_SUCCESS:
      return state
        .set('fetchingOrgUsersData', SUCCESS)
        .set('orgUsers', fromJS(action.data));
    case actionTypes.GET_ORG_USERS_DATA_FAILURE:
      return state
        .set('fetchingOrgUsersData', FAILURE)
        .set('orgUsers', fromJS([]));
