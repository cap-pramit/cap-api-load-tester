...
export const actionTypes = defineActionTypes(
  {
    ...
    GET_ORG_USERS_DATA_REQUEST: "GET_ORG_USERS_DATA_REQUEST",
    GET_ORG_USERS_DATA_SUCCESS: "GET_ORG_USERS_DATA_SUCCESS",
    GET_ORG_USERS_DATA_FAILURE: "GET_ORG_USERS_DATA_FAILURE",
